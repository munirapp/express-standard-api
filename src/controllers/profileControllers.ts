  ...
  async getAllProfile(req, res) {
    ...
    try {
      ...
      if (!dataAllProfile) {
        ...
        dataAllProfile = await this.profileModel().all()
  ...
  async getPaginateProfile(req, res) {
    ...
    try {
      ...
      if (!dataPaginateProfile) {
        ...
        dataPaginateProfile = await this.profileModel().paginate(limit, offset)
        // Set data in Redis for 5 minutes
  ...
  async getProfileID(req, res) {
    ...
    try {
      ...
      if (!dataProfileID) {
        ...
        dataProfileID = await this.profileModel().findByID(id)
        // Set data in Redis for 5 minutes
